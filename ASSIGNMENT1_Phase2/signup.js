...
if(email_validation(email,error1))
{
    ...
    {
        if(cnfpwd_validation(cnfpwd,pwd,error3))
        {
            if(phone_validation(phone,error4))
            {
                return true;
            }
        }
...
function cnfpwd_validation(cnfpwd,pwd,error3)
{   
...
function phone_validation(phone,error4)
{   
    var phoneformat = /^\d{3}\d{3}\d{4}|\d{3}-\d{3}-\d{4}|\d{3} \d{3} \d{4}/;
